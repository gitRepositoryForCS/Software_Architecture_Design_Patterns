    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                string mString = JsonConvert.SerializeObject(d, Formatting.Indented, settings);
                Dictionary<string, PermEntry> back = JsonConvert.DeserializeObject<Dictionary<string, PermEntry>>(mString, settings);
